...
def main(args):
    ...
    final_output_file = os.path.join(args.weight_output_file, args.modelname, '{}_{}_{}_last_weight.pth'.format(args.modelname, args.dataset, time_str))
    best_output_mIoU = os.path.join(args.weight_output_file, args.modelname, '{}_{}_{}_best_mIoU.pth'.format(args.modelname, args.dataset, time_str))
    best_output_acc = os.path.join(args.weight_output_file, args.modelname, '{}_{}_{}_best_acc.pth'.format(args.modelname, args.dataset, time_str))
...
if __name__ == "__main__":
    ...
    # 训练网络
    parser.add_argument('--modelname', default='seg_hrnet', help='network')
    # 预训练权重地址
    ...
    # 数据集
    parser.add_argument('--dataset', default='LoveDA', help='dataset name')
    # 数据集的根目录
